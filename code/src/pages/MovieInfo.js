...
// hooks declared with useParams (getting the router parameter from the URL parameters) and useState
export const MovieInfo = () => {
    ...
    // in case of the movie is rendering
    if (!movie) {
        return <div>Ups, need a moment...</div>
    }

    // fetching the single movie in this container
    return(
        <section className="infoContainer">

            {/* Link navigates back and svg for the image "Go Back"-button */}
